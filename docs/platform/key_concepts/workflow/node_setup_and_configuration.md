...
- Select the action event for the node, such as creating a new item or fetching data.![appse ai credentials screen](/img/platform/key-concepts/workflow/node-setup-and-configuration/credential-screen-selected.jpeg)
