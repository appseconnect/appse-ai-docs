...
Let’s go through what each numbered section in the image represents :![workflow designer screen](/img/platform/key-concepts/workflow/introduction/workflow-designer.png)

### 1. Workflow name ![rename workflow](/img/platform/key-concepts/workflow/introduction/rename-workflow.png)
...
### 2. Save ![save button](/img/platform/key-concepts/workflow/introduction/save-button.png)
...
### 3. Run once![run once](/img/platform/key-concepts/workflow/introduction/run-once.png)
...
### 4. Inactive/Active Toggle ![inactive or active toggle](/img/platform/key-concepts/workflow/introduction/inactive-active-toggle.png)
...
### 5. Get started![get started button](/img/platform/key-concepts/workflow/introduction/get-started.png)
...
### 6. Apps![apps button](/img/platform/key-concepts/workflow/introduction/apps.png)
...
### 7. Actions![actions button](/img/platform/key-concepts/workflow/introduction/actions.png)
...
### 8. Notes![notes button](/img/platform/key-concepts/workflow/introduction/notes.png)
...
### 9. Import Workflow ![import workflow option](/img/platform/key-concepts/workflow/introduction/import-workflow.png)
...
### 10. Export Workflow![export workflow option](/img/platform/key-concepts/workflow/introduction/export-workflow.png)
...
### 11. Click to start![click to start button](/img/platform/key-concepts/workflow/introduction/click-to-start.png)
...
### 12. Undo![undo button](/img/platform/key-concepts/workflow/introduction/undo.png)
...
### 13. Redo![redo button](/img/platform/key-concepts/workflow/introduction/redo.png)
...
### 14. Zoom In![zoom in button](/img/platform/key-concepts/workflow/introduction/zoom-in.png)
...
### 15. Zoom Out ![zoom out button](/img/platform/key-concepts/workflow/introduction/zoom-out.png)
...
### 16. Fit to screen ![fit to screen button](/img/platform/key-concepts/workflow/introduction/fit-to-screen.png)
...
### 17. Tidy Up![tidy up button](/img/platform/key-concepts/workflow/introduction/tidy-up.png)
