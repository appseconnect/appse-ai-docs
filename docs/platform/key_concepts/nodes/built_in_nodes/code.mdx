...
## Configuration![Code Node Configuration](/img/platform/key-concepts/nodes/built-in/code/configuration.png)
...
This is where you write your custom code for data transformation. ![Code Node Autocomplete](/img/platform/key-concepts/nodes/built-in/code/code-editor.png)
...
## Accessing Data![Code Node Autocomplete](/img/platform/key-concepts/nodes/built-in/code/autocomplete.png)

### `$input`![Code Node Input](/img/platform/key-concepts/nodes/built-in/code/immediate-parent.png)
...
### `$input.all()`![Code Node Previous Node](/img/platform/key-concepts/nodes/built-in/code/input-all.png)
...
### `$('Node Name')`![Code Node Previous Node](/img/platform/key-concepts/nodes/built-in/code/descendants.png)
...
1.  Select the **Code Node** from the node selection screen.![Code Node Selection](/img/platform/key-concepts/nodes/built-in/code/selection.png)

---

2.  Connect it to a node that provides data (e.g., an HTTP Request Node or App Node).![Code Node Connection](/img/platform/key-concepts/nodes/built-in/code/connection.png)
...
- Posted to Microsoft Teams![connect html source](/img/platform/key-concepts/nodes/built-in/code/orderSummaryFlow.png)
...
---![convert currency workflow](/img/platform/key-concepts/nodes/built-in/code/convertCurrencySymbolWorkflow.png)
...
```![connect html source](/img/platform/key-concepts/nodes/built-in/code/shipstationWorkflow.png)
