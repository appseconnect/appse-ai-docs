...
2. Navigate to the **AI Agent, LLM and Tools** section.![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent1.png)
3. Select **AI Agent Node**.![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent2.png)
...
### Example Configuration![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent3.png)
...
1. Click on the designated port labeled as Model![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent4.png)
2. Select the required Language Model![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent5.png)
3. Configure the fields displayed and continue![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent6.png)
...
### Example Configuration ![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent7.png)
---
...
1. Click on the designated port labeled as Tools![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent8.png)
2. Select the required Tool![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent9.png)
3. Configure the fields displayed![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent10.png)
...
### Example Configuration![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent11.png)
---
...
1. Click on the designated port labeled as Output Parser![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent12.png)
2. Provide the required JSON in the JSON Example field ![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent13.png)
...
### Example Configuration![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent14.png)
---

## Sample Execution
### Input Configurations
The workflow configuration used to execute the AI Agent Node.![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent15.png)

### Output Generated
The response produced by the AI Agent after processing the input configuration.![](/img/platform/key-concepts/nodes/built-in/ai-agent/agent16.png)
