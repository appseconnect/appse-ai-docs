...
3. Click on the Zoho Developer Console link![click on Zoho developer console](/img/credentials/zoho-desk/click_on_zoho_developer_console.png)

### Step 4: Sign In to Developer Console
Sign in with the same account you used to create a Zoho Desk account:![sign in with your details](/img/credentials/zoho-desk/sign_in_with_your_details.png)

### Step 5: Get Started
Click on 'Get started':![get started](/img/credentials/zoho-desk/get_started.png)

### Step 6: Choose Client Type
Select 'Server-based applications':![server based applications](/img/credentials/zoho-desk/choose_a_client_type.png)
