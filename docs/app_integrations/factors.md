...
| Bearer Token    | Your Factors API key                        |

### Step-by-Step Guide

#### 1. Add Connection Name

- Provide a descriptive name for your connection (e.g., `Factors Analytics`, `Marketing Data Feed`).
...
- If successful, your Factors credential will show a "✓" icon. Now you can use this application for your integrations.
