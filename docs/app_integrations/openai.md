...
![APPSeAI OpenAI api keys](/img/credentials/openai/api-keys.png)
<br/>

Next, give a name to your key and click on “Create Secret Key”
![APPSeAI OpenAI Create Secret Key](/img/credentials/openai/create-secret-key.png)
...
![APPSeAI OpenAI secret key](/img/credentials/openai/secret-key.png)
