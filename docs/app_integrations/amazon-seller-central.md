...
![appse ai Amazon Seller Central Connection Name](/img/credentials/amazon-seller-central/create-new-credential-appseai-amazon-seller-central.png)
...
![appse ai Amazon Seller Central region and marketplace selector](/img/credentials/amazon-seller-central/select-region-seller-central.png)
...
![appse ai Amazon Seller Central enter password](/img/credentials/amazon-seller-central/enter-password-seller-central.png)

Enter the one-time password (OTP) sent to your registered device.
![appse ai Amazon Seller Central enter OTP](/img/credentials/amazon-seller-central/enter-otp-seller-central.png)

Select your country from the dropdown.
![appse ai Amazon Seller Central select country](/img/credentials/amazon-seller-central/select-country-seller-central.png)

Click **Confirm** to complete the verification process.
![appse ai Amazon Seller Central click confirm](/img/credentials/amazon-seller-central/click-confirm-seller-central.png)

Click **Save and Authorize** in appse ai to complete the connection.
![appse ai Amazon Seller Central save and authorize button](/img/credentials/amazon-seller-central/click-save-authorize-appseai-amazon-seller-central.png)
