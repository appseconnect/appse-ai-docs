...
![appse ai Tavily Select Credential](/img/credentials/tavily/create-new-cred-tavily.png)

<br/>

This opens the Tavily credential form. Add your **Connection Name**.
![appse ai Tavily Connection Name](/img/credentials/tavily/enter-connection-name-tavily.png)
...
![appse ai Tavily Get API Key](/img/credentials/tavily/copy-api-key-tavily.png)
...
![appse ai Tavily Save Credential](/img/credentials/tavily/paste-tavily-api-key.png)
