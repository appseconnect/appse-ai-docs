...
![Airtable Builder Hub](/img/credentials/airtable/airtable-builder-hub.png)

#### 3. Create Personal Access Token

Navigate to **Personal Access Token** section and click on **Create new token** to generate a new token.
![Airtable Create Token](/img/credentials/airtable/airtable-create-token.png)
...
![Airtable Configure Token](/img/credentials/airtable/airtable-configure-create-token.png)
...
![Airtable Token Created](/img/credentials/airtable/airtable-token-created.png)
...
![Airtable Configure Credential](/img/credentials/airtable/airtable-configure-new-credential.png)
...
![Airtable Database Table](/img/credentials/airtable/airtable-database-table.png)
...
```
![Airtable Create Record](/img/credentials/airtable/airtable-create-record.png)
