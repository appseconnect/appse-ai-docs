...
![APPSeAI microsoft teams choose account](/img/credentials/microsoft-teams/choose-account.png)
...
![appse ai microsoft teams admin grants permissions](/img/credentials/microsoft-teams/admin-grants-permissions.png)
...
![appse ai microsoft teams non admin users alert](/img/credentials/microsoft-teams/non-admin-user-alert.png)
