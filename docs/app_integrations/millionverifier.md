...
Follow the steps below to quickly find your API key and complete the credential setup.
...
| API Key         | Your MillionVerifier API key                |

### Step-by-Step Guide

#### 1. Add Connection Name

- Provide a descriptive name for your connection (e.g., `Email Verifier`, `Million Verifier Main`).
...
- If successful, your MillionVerifier credential will show a "✓" icon. Now you can use this application for your integrations.
- If it fails, you will be displayed a "!" icon. In that case, please recheck your API Key or contact support.
