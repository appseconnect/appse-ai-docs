...
![APPSeAI SendGrid API Keys Menu](/img/credentials/sendgrid/api-keys-menu.png)
<br/>

#### 3. Create API Key

Click on the **Create API Key** button in the top right corner.
![APPSeAI SendGrid Create Button](/img/credentials/sendgrid/create-api-key.png)
<br/>
...
![APPSeAI SendGrid Key Permissions](/img/credentials/sendgrid/api-key-permissions.png)
<br/>
...
![APPSeAI SendGrid Sender Verification](/img/credentials/sendgrid/sender-verification.png)
