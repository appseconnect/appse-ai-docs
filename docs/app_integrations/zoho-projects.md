...
3. Click on the Zoho Developer Console link![click on Zoho developer console](/img/credentials/zoho-projects/click_on_zoho_developer_console.png)

### Step 4: Sign In to Developer Console
Sign in with the same account you used to create a Zoho Projects account:![sign in with your details](/img/credentials/zoho-projects/sign_in.png)

### Step 5: Get Started
Click on 'Get started':![get started](/img/credentials/zoho-projects/get_started.png)

### Step 6: Choose Client Type
Select 'Server-based applications':![server based applications](/img/credentials/zoho-projects/choose_a_client_type.png)
